...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
      <a href="index.html" class="app-brand-link">
        ...
        <span class="app-brand-text demo menu-text fw-bolder ms-2">SpotTiket</span>
      </a>
    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item {{ request()->is('admin/organizers*') ? 'active' : '' }}">
        <a href="/admin/organizers" class="menu-link">
      ...
      <li class="menu-item {{ request()->is('admin/users*') ? 'active open' : '' }}">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          ...
          <div data-i18n="Account Users">Users</div>
        </a>
        <ul class="menu-sub">
          <li class="menu-item {{ request()->is('admin/users/admins*') ? 'active' : '' }}">
            <a href="/admin/users/admins" class="menu-link">
              <div data-i18n="Admins">Admins</div>
            </a>
          </li>
          <li class="menu-item {{ request()->is('admin/users/members*') ? 'active' : '' }}">
            <a href="/admin/users/members" class="menu-link">
